...
public class BillController {
    ...
    public ResponseEntity<ApiResponse<String>> deleteMethodName(HttpServletRequest request, @PathVariable("id") UUID billId) {
        UUID userId = UUID.fromString((String) request.getAttribute("userId"));

        billService.deleteBill(userId, billId);

        ApiResponse<String> response = new ApiResponse<>(true, "Bill deleted successfully", null);
